...
export default async function ClinicPortalHome() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[40px] border border-slate-800/80 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.12),_transparent_20%),linear-gradient(180deg,#0b1220_0%,#0d1524_42%,#101826_100%)] p-5 shadow-[0_30px_120px_rgba(2,6,23,0.35)]">
            ...
            <CardContent className="relative p-8 md:p-10">
              ...
              <div className="relative z-10 space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="max-w-2xl text-sm leading-7 text-slate-300">
                        The home surface keeps the same information and actions, but organizes them into clearer modules so patient flow, visits, and clinic administration stay readable across a full day of use.
                      </p>
                    </div>
                  </div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <ArrowRight className="mt-1 size-4 shrink-0 text-slate-500 transition-transform group-hover:translate-x-1 group-hover:text-white" />
                          </div>
                        </Link>
                      );
                    })}
                ...
                <div className="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
                  ...
                  <div className="rounded-[32px] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">Visit stream</p>
                      <h3 className="mt-2 text-2xl font-bold tracking-tight text-white">Latest diagnoses</h3>
                    </div>
              ...
              <CardContent className="p-8">
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-2 break-words text-2xl font-bold tracking-tight text-white">{membership.clinicName}</h3>
                  </div>
                ...
                <div className="mt-8 grid gap-4">
                  <div className="rounded-[28px] border border-white/10 bg-white/5 p-5">
                    <div className="flex items-center justify-between gap-4">
                      <div className="min-w-0">
                        ...
                        <p className="mt-2 break-words text-lg font-semibold text-white">{planLabel}</p>
                      </div>
                  ...
                  <div className="rounded-[28px] border border-white/10 bg-white/5 p-5">
                    <div className="flex items-center gap-3">
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-2xl bg-sky-500/12 text-sky-300">
                        <Shield className="size-4" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">Environment</p>
                        <p className="mt-1 break-words text-sm font-semibold text-white">Low-glare desktop mode</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[28px] border border-white/10 bg-white/5 p-5">
                    ...
                    <div className="mt-4 space-y-3">
                      <div className="flex items-center gap-3 rounded-2xl bg-white/5 px-4 py-3">
                        <UsersRound className="size-4 shrink-0 text-sky-300" />
                      ...
                      <div className="flex items-center gap-3 rounded-2xl bg-amber-400/8 px-4 py-3">
                        <ClipboardList className="size-4 shrink-0 text-amber-300" />
                        <span className="text-sm text-slate-200">Verify active prescription templates</span>
                      </div>
                      <div className="flex items-center gap-3 rounded-2xl bg-white/5 px-4 py-3">
                        <Stethoscope className="size-4 shrink-0 text-sky-300" />
            ...
            <CardContent className="grid gap-3 md:grid-cols-2 2xl:grid-cols-4">
              {["Search and open patients", "Register a new patient", "Add diagnosis and plan", "Print visit prescription view"].map((item, index) => (
                <div key={item} className={`min-w-0 flex items-center gap-3 rounded-[22px] border px-4 py-3 text-sm ${index === 1 ? "border-amber-400/20 bg-amber-400/8 text-slate-100" : "border-white/10 bg-white/5 text-slate-200"}`}>
                  <ClipboardList className={`size-4 shrink-0 ${index === 1 ? "text-amber-300" : "text-sky-300"}`} />
