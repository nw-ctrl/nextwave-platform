...
const pageTitle = "Manage Doctors";
const pageIntro = "This module now matches the modern portal shell while staying safely gated behind the existing clinic admin role.";
const pageBody = "Use this area for doctor roster, permissions, and future clinic member management flows.";
