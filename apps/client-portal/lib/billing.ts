  ...
  const session = await client.checkout.sessions.create(
    {
      ...
      success_url: `${input.origin}/billing?clientId=${input.clientId}&userId=${input.userId}&checkout=success&session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${input.origin}/billing?clientId=${input.clientId}&userId=${input.userId}&checkout=cancel`,
